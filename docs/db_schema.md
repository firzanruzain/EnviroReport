...
CREATE TABLE public.form_field (
  ...
  field_type_id character varying NOT NULL,
...
CREATE TABLE public.form_template (
  ...
  pollution_type_id character varying NOT NULL,
  status USER-DEFINED,
...
CREATE TABLE public.pollution_type (
  pollution_type_id character varying NOT NULL,
  division_id character varying NOT NULL,
  pollution_type_name character varying NOT NULL,
  pollution_type_description character varying NOT NULL,
